            ...
            <div className="container">
                <div className="card">
                    ...
                    <div className="task_inputs">
                        <input type="text" value={inputText} placeholder="Enter your Timeline" onChange={InputEvent} />
                        <button onClick={Addlist} className="add_button">submit</button>
                    </div>
                    ...
                    <ul className="item_list">
                        ...
                        return <>
                            <ListItems id={index} key={index} list_name={itemval} onSelect={deleteList} />
                        </>
